...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login("sonacharusuhani@gmail.com",passw)
    server.sendmail("sonacharusuhani@gmail.com",to,content)
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            try:
                ...
                content=takeCommand()
                to="shreyajain11072003@gmail.com"
